...
export default function EventDetail() {
    ...
    (async () => {
      ...
      try {
        ...
        if (user && user.userType === "organizer") {
          ...
          // normal users just see their own queries from /user/queries page
  ...
  async function postQuery(e) {
    ...
    try {
      ...
      setQueryText("");
      // if you want, you can refetch queries here when user is an organizer
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              {event.images && event.images.length > 0 ? (
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {event.images.map((src, idx) => (
                    <div
                      key={idx}
                      className="h-56 bg-gray-100 rounded overflow-hidden"
                    >
                      <img
                        src={src}
                        alt={`${event.title}-${idx}`}
                ...
                <div className="mt-4 h-56 bg-gray-100 rounded flex items-center justify-center text-gray-500">
                  No images
                </div>
              )}
              ...
              <div className="mt-6 flex items-center gap-3">
                <button
                  onClick={toggleLike}
                  className="px-3 py-2 rounded shadow bg-coffee-dark text-coffee-cream"
                >
                ...
                <div>
                  ...
                  {event.organizer?._id && (
                    <Link
                      ...
                      className="text-xs text-coffee-mid"
                    >
                      View profile
                    </Link>
                  )}
                ...
                <form onSubmit={postQuery} className="mt-3">
                  ...
                  <div className="mt-2 flex gap-2">
                    <button
                      type="submit"
                      disabled={qLoading}
                      className="bg-coffee-mid text-white px-3 py-1 rounded"
                    >
                      Post
                    </button>
                    <button
